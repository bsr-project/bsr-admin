      ...
      <div class="mission-viewer-body flexB_ mt-20">
        ...
        <div class="join-mission-table">
          <el-table :data="list" border>
            ...
            <el-table-column label="姓名" prop="join_user_id.realname" width="100"></el-table-column>
            <el-table-column label="蓝天编号" prop="join_user_id.bsr_code" width="120"></el-table-column>
  ...
  ExportExcel() {
    ...
    _.forEach(this.list, (mission, index) => {
      missionData.push([
        ...
        // 信息人
        _.get(mission.join_user_id, 'realname', '未知用户'),
        // 蓝天编号
        _.get(mission.join_user_id, 'bsr_code', '未知编号'),
        // 出发交通工具
        ...
        _.get(mission, 'sign_in_vehicle') === VEHICLE.DRIVE ||
          ...
          _.get(mission.join_user_id, 'car_number', '未知车牌') : '',
        // 出发时间
